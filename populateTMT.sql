...
INSERT INTO Theaters.List(AccountId, MovieId, ShowTime, Theater)
	VALUES  (1, 1,  '11:00:00', 'TMT Columbia'),
			(1, 3,  '19:30:00', 'TMT Columbia'),
		    (2, 2,  '02:00:00', 'TMT Jefferson City'),
			(2, 5,  '12:00:00', 'TMT Columbia'),
		    (3, 1,  '11:00:00', 'TMT Jefferson City'),
		    (4, 1,  '17:00:00', 'TMT Jefferson City'),
			(4, 4,  '22:00:00', 'TMT Columbia'),
		    (5, 6,  '17:00:00', 'TMT Columbia')

SELECT * FROM Theaters.List;


INSERT INTO Theaters.Review(MovieId, ListId, StarRating, Comment, ReviewDate, Total)
	VALUES (1, 1, 5, 'Lots of great action and a perfect picture!', '2021-03-28 10:54:32', 2),
		   (6, 2, 3, 'This movie is great for kids. Boring for parents.', '2021-01-17 09:04:00', 1),
		   (3, 4, 5, 'Best film of 2021!', '2021-04-13 12:00:32', 6),
		   (4, 8, 1, 'Terrible, terrible movie. Marvel is better!', '2021-06-30 01:32:10', 1),
		   (5, 7, 4, 'Okay, kind of sad. Some cute parts.', '2018-02-28 12:12:22', 5),
		   (2, 1, 2, 'Alright kids movie.', '2021-08-30 14:30:30', 2)
